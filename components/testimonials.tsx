        ...
        <div className="py-12 md:py-20 border-t border-gray-800">
          ...
          <div className="max-w-sm mx-auto grid gap-8 lg:grid-cols-3 lg:gap-6 items-start lg:max-w-none">
            ...
            <div className="flex flex-col h-full p-6 bg-gray-800" data-aos="fade-up">
              ...
              <blockquote className="text-lg text-gray-400 grow">— Nexuco lets me quickly get the insights I care about so that I can focus on my productive work. I've had Nexuco for about 24 hours now and I honestly don't know how I functioned without it before.</blockquote>
