          ...
          <div className="max-w-sm mx-auto">
            ...
            <form>
              ...
              <div className="text-sm text-gray-500 text-center">
                I agree to be contacted by Nexuco about this offer as per the Nexuco <Link href="#" className="underline text-gray-400 hover:text-gray-200 hover:no-underline transition duration-150 ease-in-out">Privacy Policy</Link>.
              </div>
            ...
            <div className="text-gray-400 text-center mt-6">
              Already using Nexuco? <Link href="/signin" className="text-purple-600 hover:text-gray-200 transition duration-150 ease-in-out">Sign in</Link>
            </div>
          </div>
